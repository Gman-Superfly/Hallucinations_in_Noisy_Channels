...
**Core thesis**: Preserving all information does not imply useful organization. This distinction explains why training matters for representation quality.
...
**Key implication**: Since injectivity is proven, representation quality depends on **organization**. The remaining question asks whether preserved information is accessible.
...
**Key point**: Injectivity is necessary for useful representations, and it does not supply useful organization by itself.
...
**Conclusion**: Training transforms random storage into organized retrieval.
...
**Implication**: Organization emerges from training and is determined by what is being represented.
...
| Injectivity holds at initialization and after training | **Proven** | Nikolaou et al. (2025) |
| Training creates organization | **Proven** | NextLat: latents converge to belief states |
| Organization is universal | **Strong support** | vec2vec: >0.92 similarity across architectures |
...
**Key point**: Since injectivity is now **mathematically proven**, representation quality depends on one question: **Is the information organized usefully?**
...
- **Proven in the cited settings**: Training creates organization (NextLat, vec2vec): Library B requires training
