...
- Semantic proximity: Similar sequences nearby? X Not guaranteed
- Structured organization: Related sequences clustered? X Not guaranteed
- Efficient extraction: Features linearly accessible? X Not guaranteed
